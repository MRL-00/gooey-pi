...
description: Create, inspect, edit, pause, resume, run, and delete durable Prime Work scheduled tasks. Use when the user asks to schedule recurring or one-time work in the current project or thread. Use rlm-heartbeat instead for temporary internal polling while actively working.
---

# Prime Work Schedules

Use this capability for durable, user-visible tasks. Prime Work must be running.
