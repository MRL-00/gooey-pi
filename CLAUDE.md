...
- Harness work starts at `electron/main/harness.ts` (descriptors) and `electron/main/agent-rpc/harness-adapter.ts` (protocol adapters); the design rationale and protocol mapping live in `docs/omp-integration.md`.
