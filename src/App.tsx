...
export default function App() {
  ...
  const refreshWorktrees = useCallback(async () => {
    ...
    if (!bridge || !cwd) { setWorktrees([]); setWorktreesLoading(false); return }
  ...
  }, [activeProject?.harness, activeProject?.primaryFolder, bridge, reportError])
  ...
  const pluginScope = activeProject?.primaryFolder ? activeProject.primaryFolder : undefined
