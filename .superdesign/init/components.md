...
Shared buttons, selects, focus-contained modals, identity, empty-state, status, and segmented-control primitives.
...
Pointer and keyboard accessible horizontal/vertical split-pane handle.
...
Safe model-authored Markdown/GFM renderer with raw HTML and remote images disabled.
